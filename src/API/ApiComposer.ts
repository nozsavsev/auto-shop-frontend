...
export const SSR_BasePath = process.env.NEXT_PUBLIC_SSR_API_URL || "http://localhost:5005";
export const Client_BasePath = process.env.NEXT_PUBLIC_API_URL || "http://localhost:5005";
