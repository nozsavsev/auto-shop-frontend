...
import { IoEyeOutline, IoEyeOffOutline, IoShuffleOutline } from "react-icons/io5";
                ...
                <Form className="space-y-4">
                  <div>
                    ...
                    <Field
                      name="name"
                      type="text"
                      className="mt-1 block w-full rounded-md border border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 px-3 py-1.5 outline-transparent"
                    />
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <Field
                        ...
                        className="mt-1 block w-full rounded-md border border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 px-3 py-1.5 outline-transparent pr-10"
                      />
                      <button
                        type="button"
